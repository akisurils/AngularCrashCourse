...
- Create Angular project with ng: `ng new angularcrashcourse.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularcrashcourse.client.esproj`).
